    ...
    try {
      const data: Project[] = [
        // Existing Projects
        {
          ...
          github: 'https://github.com/naureen/jiralite',
          demo: '#',
        ...
        },
        {
          ...
          github: 'https://github.com/naureen/hate-speech-detector',
          demo: '#',
    ...
    },
        {
          ...
          github: 'https://github.com/naureen/bookvault',
          demo: '#',
        ...
        },
        {
          ...
          github: 'https://github.com/naureen/portfolio',
          demo: 'https://naureen-portfolio.netlify.app',
        ...
        // New high-impact projects for top companies
        {
          ...
          description: 'RESTful API for task management using Python, Flask and JWT authentication.',
          technologies: ['Python', 'Flask', 'REST API', 'PostgreSQL'],
          github: 'https://github.com/naureen/taskmaster-api',
          demo: '#',
        ...
        },
        {
          ...
          description: 'Full-stack realtime chat application using React frontend and Flask backend with WebSockets.',
          technologies: ['React', 'Flask', 'WebSockets', 'JavaScript'],
          github: 'https://github.com/naureen/realtime-chat-app',
          demo: '#',
        ...
        },
        {
          ...
          description: 'Personal finance tracker with React frontend and Express REST API backend.',
          technologies: ['React', 'Express', 'REST API', 'MongoDB'],
          github: 'https://github.com/naureen/expense-tracker',
          demo: '#',
          image: 'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&w=800&q=80',
        },
        {
          ...
          github: 'https://github.com/naureen/weather-dashboard',
          demo: '#',
